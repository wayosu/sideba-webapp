...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="<?= $base_url; ?>assets/bootstrap/index3.html" class="navbar-brand">
                    <img src="<?= $base_url; ?>assets/images/logo.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
                    <span class="brand-text font-weight-normal">SIDEBA</span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="index3.html" class="nav-link">Layanan</a>
                        </li>
                        <li class="nav-item">
