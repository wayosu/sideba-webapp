        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <div class="d-flex align-items-center">
                    ...
                    <h1 class="m-0 ml-2 text-dark text-lg font-weight-normal">Data Surat Keterangan Tidak Mampu</h1>
                </div>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="card-title">Daftar Pengajuan Surat Keterangan Tidak Mampu</h4>
                        ...
                        <table id="example1" class="table table-striped text-sm">
                            ...
                            <tbody>
                                <?php
                                    $result_sktm = $mysqli->query("SELECT * FROM pengajuan_surat WHERE id_surat='1' AND id_user='$row_data[id]'");
                                    $no=1;
                                                                ...
                                                                ?>
                                                                    <div class="d-flex">
                                                                        <form action="" method="post" class="mr-1">
                                                                            ...
                                                                            <button type="submit" name="hapus_sktm" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i> Hapus</button>
                                                                        </form>
                                                                    </div>
                                                                <?php
                                                                echo"";
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <form action="" method="post">
                    ...
                    <button type="submit" name="kirim_pengajuan_sktm" class="btn btn-sm btn-primary">Kirim Perngajuan</button>
                </form>
            </div>
        </div>
    </div>
