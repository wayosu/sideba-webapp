                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="example1" class="table table-striped text-sm">
                            ...
                            <tbody>
                                <?php
                                    $result_sktm = $mysqli->query("SELECT * FROM pengajuan_surat WHERE id_surat='3' AND id_user='$row_data[id]'");
                                    $no=1;
                                        ...
                                        echo"
                                                ...
                                                ";
                                                            if ($row_sktm['status'] == 'Sedang Diproses') {
                                                                ...
                                                                ?>
                                                                    <div class="d-flex">
                                                                        <form action="" method="post" class="mr-1">
                                                                            ...
                                                                            <button type="submit" name="hapus_sku" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i> Hapus</button>
                                                                        </form>
                                                                    </div>
                                                                <?php
                                                                echo"";
                                                                ...
                                                                echo "";
                                                                ?>
                                                                    <form action="<?= $base_url; ?>user/cetak_sku" method="post" target="_BLANK">
                                                                        <input type="hidden" name="id" value="<?= $row_sktm['id_user']; ?>">
                                                                        <button type="submit" name="cetak_sku" class="btn btn-xs btn-primary"><i class="fas fa-download"></i> Download</button>
                                                                    </form>
                                                                <?php
                                                                echo"";
                                                            }
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <form action="" method="post">
                    ...
                    <input type="hidden" name="id_surat" value="3">
                    <button type="submit" name="kirim_pengajuan_sku" class="btn btn-sm btn-primary">Kirim Perngajuan</button>
                </form>
            </div>
        </div>
    </div>
