                                        ...
                                        echo"
                                                ...
                                                ";
                                                            if ($row_sktm['status'] == 'Sedang Diproses') {
                                                                ...
                                                                echo "";
                                                                ?>
                                                                    <form action="<?= $base_url; ?>user/cetak_skkb" method="post" target="_BLANK">
                                                                        <input type="hidden" name="id" value="<?= $row_sktm['id_user']; ?>">
                                                                        <button type="submit" name="cetak_skkb" class="btn btn-xs btn-primary"><i class="fas fa-download"></i> Download</button>
                                                                    </form>
                                                                <?php
                                                                echo"";
                                                            }
