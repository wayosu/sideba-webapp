                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="example1" class="table table-striped text-sm">
                            ...
                            <tbody>
                                <?php
                                    $result_sktm = $mysqli->query("SELECT * FROM pengajuan_surat WHERE id_surat='2'");
                                    $no=1;
                                                                ...
                                                                ?>
                                                                    <div class="d-flex">
                                                                        <form action="" method="post" class="mr-1">
                                                                            ...
                                                                            <button type="submit" name="terima_skkb" class="btn btn-xs btn-success"><i class="fas fa-check"></i> Terima</button>
                                                                        </form>
                                                                        <form action="" method="post" class="ml-1">
                                                                            <input type="hidden" name="id" value="<?= $row_sktm['id']; ?>">
                                                                            <button type="submit" name="tolak_skkb" class="btn btn-xs btn-danger"><i class="fas fa-times"></i> Tolak</button>
                                                                        </form>
                                                                    </div>
                                                                <?php
                                                                echo"";
