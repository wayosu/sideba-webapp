                                                                ...
                                                                ?>
                                                                    <div class="d-flex">
                                                                        <form action="" method="post" class="mr-1">
                                                                            ...
                                                                            <button type="submit" name="terima_sktm" class="btn btn-xs btn-success"><i class="fas fa-check"></i> Terima</button>
                                                                        </form>
                                                                        <form action="" method="post" class="ml-1">
                                                                            <input type="hidden" name="id" value="<?= $row_sktm['id']; ?>">
                                                                            <button type="submit" name="tolak_sktm" class="btn btn-xs btn-danger"><i class="fas fa-times"></i> Tolak</button>
                                                                        </form>
                                                                    </div>
                                                                <?php
                                                                echo"";
